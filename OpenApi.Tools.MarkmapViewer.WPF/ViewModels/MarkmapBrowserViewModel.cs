...
using OpenApi.Tools.MarkmapViewer.WPF.Commands;
using System;
...
namespace OpenApi.Tools.MarkmapViewer.WPF.ViewModels
{
    public class MarkmapViewerViewModel : ViewModelBase
    {
        ...
        public MarkmapViewerViewModel(IOpenApiTools openApiTools, IAlertService alertService)
        {
            ...
            LoadItemsCommand = new RelayCommand(p => true, LoadItems);
            ShowNextItemCommand = new RelayCommand(p => true, ShowNextItem);
            ShowPreviousItemCommand = new RelayCommand(p => true, ShowPreviousItem);
        }
        ...
        private void LoadItems(object args)
        {
        ...
        private void ShowNextItem(object args)
        {
            if (!string.IsNullOrEmpty(SelectedItem))
            {
        ...
        private void ShowPreviousItem(object args)
        {
            if (!string.IsNullOrEmpty(SelectedItem))
            {
                var index = Items.IndexOf(SelectedItem);
